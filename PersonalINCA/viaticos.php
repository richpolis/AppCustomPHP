...
<head>
<title>INCA Base de Datos Personal - Vi&aacute;ticos INCA</title>

<?php 

@ require_once ('header.php');
echo "<script type='text/javascript' src='js/viaticos.js'></script>";
...
echo "<h1>Vi&aacute;ticos INCA</h1>\n";
...
<h1 id="label_im">Agregar Vi&aacute;ticos</h1>

<form action="insertarViaticos.php" method="post" id="change-form" enctype='multipart/form-data'>
    
    <div class="linea">
    	<div class="etiqueta" for="fecha_salida">Fecha de salida:</div>
        <input type="text" id="fecha_salida" name="fecha_salida" class="required">
    </div>
    
    <div class="linea">
    	<div class="etiqueta" for="fecha_regreso">Fecha de regreso:</div>
        <input type="text" id="fecha_regreso" name="fecha_regreso" class="required">
    </div>
    
    <div class="linea">
    	<div class="etiqueta" for="monto">Monto autorizado:</div>
    ...
    <div class="linea">
        ...
        <input type="hidden" value="" name="id_viatico" />
    </div>
