...
if (mysql_num_rows($result)!=0) {
	...
	$response .= "	<tr>\n".
				...
				"		<th style='width: 120px;'>Tipo de contrataci&oacute;n</th>\n".
	...
	while($row = mysql_fetch_array($result)) {
		...
		if ($row["tipo_contratacion"] != NULL && $row["tipo_contratacion"] != 0 && $_SESSION['nivel'] == 0) {
			$response .="<a href='#' onclick='return iniModificar(".$row["id_empleado"].
						");' title='Modificar Recibos de Honorarios'><img src='images/form_edit.png' /></a>";
		}					
		$response .="</td>";
		$response .= "		<td class='$class'>\n".
